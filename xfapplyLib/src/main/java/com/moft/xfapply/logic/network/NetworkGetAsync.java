...
public class NetworkGetAsync extends AsyncTask<String, Integer, String>  {
    private OnNetworkGetResultListener listener;
    private String url;
    
    public NetworkGetAsync(String url, OnNetworkGetResultListener listener) {  
        super();
    ...
    protected String doInBackground(String... params) {
        ...
        String result = hs.get(url, params[0]);
    ...
    public interface OnNetworkGetResultListener{
