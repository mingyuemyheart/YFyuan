...
import com.moft.xfapply.utils.cluster.clustering.algo.Algorithm;
import com.moft.xfapply.utils.cluster.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.moft.xfapply.utils.cluster.clustering.algo.PreCachingAlgorithmDecorator;
import com.moft.xfapply.utils.cluster.clustering.view.ClusterRenderer;
import com.moft.xfapply.utils.cluster.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onMapStatusChange(MapStatus mapStatus) {
        ...
        if (mOnMapStatusChangeListener != null) {
            mOnMapStatusChangeListener.onChanged();
        }
    ...
    public void onMapStatusChangeFinish(MapStatus mapStatus) {
        ...
        MapStatus position = mMap.getMapStatus();
        if (mPreviousCameraPosition != null && mPreviousCameraPosition.zoom == position.zoom) {
            mRenderer.onClustersChanged(null);
        } else {
            cluster();
        }
        mPreviousCameraPosition = mMap.getMapStatus();
    ...
    public void setOnMapStatusChangeListener(OnMapStatusChangeListener mOnMapStatusChangeListener) {
