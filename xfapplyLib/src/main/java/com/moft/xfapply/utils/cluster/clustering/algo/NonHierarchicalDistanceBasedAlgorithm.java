...
import com.moft.xfapply.utils.cluster.projection.Bounds;
...
import com.moft.xfapply.utils.cluster.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.moft.xfapply.utils.cluster.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.moft.xfapply.utils.cluster.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.moft.xfapply.utils.cluster.clustering.algo.StaticCluster<T> cluster =
                        new com.moft.xfapply.utils.cluster.clustering.algo
