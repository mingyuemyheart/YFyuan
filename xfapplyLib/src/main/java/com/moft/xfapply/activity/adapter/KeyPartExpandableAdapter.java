 ...
 */
public class KeyPartExpandableAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<KeyPartCategary> groupList;
    private OnGroupClickListener listener;

    public KeyPartExpandableAdapter(Context context, List<KeyPartCategary> keyPartCategaries) {
        this.context = context;
        groupList = keyPartCategaries;
    }
    ...
    public int getChildrenCount(int groupPosition) {
        ...
        if (groupPosition < groupList.size() && groupList.get(groupPosition) != null) {
            ...
            count = groupList.get(groupPosition).getKeyPartInfos().size();
        } else {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return groupList.get(groupPosition).getKeyPartInfos().get(childPosition);
    }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        KeyPartCategary info = groupList.get(groupPosition);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        IKeyPartInfo info = groupList.get(groupPosition).getKeyPartInfos().get(childPosition);
        viewHolder.tv_name.setText(getValue(info.getName(), "未知名称"));
