...
public class KeyUnitKeyPartDetailActivity extends BaseActivity {
    public static final int REQUEST_DETAIL_ACTIVITY_CODE = 5003;
    private TextView tv_title = null;
    private LinearLayout ll_content = null;

    private IKeyPartInfo info;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_key_part_detail);
    ...
    private boolean initData() {
        ...
        info = (IKeyPartInfo) intent.getSerializableExtra("info");
    ...
    protected void createComLocation(IKeyPartInfo info) {
