...
public class KnowledgeAdapter extends BaseAdapter {
    ...
    private List<KnowledgeBaseDTO> fileNodeList;
    private OnItemSelectedListener listener;

    private ViewHolder mHolder;

    public KnowledgeAdapter(Context context, List<KnowledgeBaseDTO> list, OnItemSelectedListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_knowledge, null);
        ...
        final KnowledgeBaseDTO info = fileNodeList.get(position);
    ...
    public interface OnItemSelectedListener{
        void onItemClick(KnowledgeBaseDTO info);
        void onItemLongClick(KnowledgeBaseDTO info);
    }
