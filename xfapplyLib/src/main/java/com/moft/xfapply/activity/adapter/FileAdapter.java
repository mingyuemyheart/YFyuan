...
public class FileAdapter extends BaseAdapter {
    ...
    private List<FileNodeDBInfo> fileNodeList;
    private OnItemSelectedListener listener;

    private ViewHolder mHolder;

    public FileAdapter(Context context, List<FileNodeDBInfo> list, OnItemSelectedListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final FileNodeDBInfo info = fileNodeList.get(position);
    ...
    public interface OnItemSelectedListener{
        void onItemClick(FileNodeDBInfo info);
        void onItemLongClick(FileNodeDBInfo info);
    }
