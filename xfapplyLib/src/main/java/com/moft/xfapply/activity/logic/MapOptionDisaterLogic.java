...
public class MapOptionDisaterLogic extends ViewLogic {
    public MapOptionDisaterLogic(View v, Activity a) {
        super(v, a);
    }

    private OnMapOptionDisaterLogicListener mListener = null;
    ...
    public void setListener(OnMapOptionDisaterLogicListener l) {
        mListener = l;
    }
    ...
    public void init() {
        popupView = getActivity().getLayoutInflater().inflate(R.layout.map_popup_option_disaster, null);
    ...
    public interface OnMapOptionDisaterLogicListener{
        void onMeasureDis();
        void onMeasureArea();
        void onDismiss();
    }
