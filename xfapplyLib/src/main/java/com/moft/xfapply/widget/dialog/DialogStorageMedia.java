...
public class DialogStorageMedia {
    public static void show(Context cxt, boolean isEdit, String title, StorageMediaJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
        final AlertDialog dlg = new AlertDialog.Builder(cxt).create();
        dlg.show();
        Window window = dlg.getWindow();

        window.clearFlags(WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
        window.setContentView(R.layout.dialog_keyunit_storage_media);
    ...
    private static void initEditView(final AlertDialog dlg, Window window, final StorageMediaJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
        ...
        final EditText et_height = (EditText) window.findViewById(R.id.et_height);
        ...
        et_height.setText(StringUtil.get(info.getHeight()));
        ...
        ll_doing_ok.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                info.setHeight(Utils.convertToDouble(et_height.getText().toString()));
    ...
    private static void initView(Window window, StorageMediaJsonInfo info) {
        ...
        final TextView tv_height = (TextView) window.findViewById(R.id.tv_height_value);
        ...
        tv_height.setText(StringUtil.get(info.getHeight()));
