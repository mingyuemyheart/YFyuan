...
public class DialogProduct {
    ...
    public static void show(Context cxt, boolean isEdit, String title, ProductJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
        final AlertDialog dlg = new AlertDialog.Builder(cxt).create();
        dlg.show();
        Window window = dlg.getWindow();

        window.clearFlags(WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
        window.setContentView(R.layout.dialog_keyunit_product);
    ...
    private static void initEditView(final AlertDialog dlg, Window window, final ProductJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
    ...
    private static void initView(Window window, ProductJsonInfo info) {
