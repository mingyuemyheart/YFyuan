...
public class DialogHazardMedia {

    public static void show(Context cxt, boolean isEdit, String title, HazardMediaJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
        final AlertDialog dlg = new AlertDialog.Builder(cxt).create();
        dlg.show();
        Window window = dlg.getWindow();

        window.clearFlags(WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
        window.setContentView(R.layout.dialog_keyunit_hazard_media);
    ...
    private static void initEditView(final AlertDialog dlg, Window window, final HazardMediaJsonInfo info, final DialogComposition.OnEditDoingListener listener) {
        ...
        final EditText et_remark = (EditText) window.findViewById(R.id.et_remark);
        ...
        et_remark.setText(StringUtil.get(info.getRemark()));
    ...
    private static void initView(Window window, HazardMediaJsonInfo info) {
        ...
        final TextView tv_remark = (TextView) window.findViewById(R.id.tv_remark);
        ...
        tv_remark.setText(StringUtil.get(info.getRemark()));
    }
