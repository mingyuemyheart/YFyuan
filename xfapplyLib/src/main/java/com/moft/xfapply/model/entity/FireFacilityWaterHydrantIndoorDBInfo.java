...
/**
 * 消防水系统-室内消火栓(fire_facility_water_hydrant_indoor)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_hydrant_indoor")
public class FireFacilityWaterHydrantIndoorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -6965811030592805793L;
 ...
 */
    ...
    public FireFacilityWaterHydrantIndoorDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("室内消火栓(层)", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterHydrantIndoorDBInfo.class));
