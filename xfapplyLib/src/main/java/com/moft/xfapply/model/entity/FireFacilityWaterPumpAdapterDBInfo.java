...
/**
 * 消防水系统-水泵接合器(fire_facility_water_pump_adapter)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_pump_adapter")
public class FireFacilityWaterPumpAdapterDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -8561242754614952510L;
 ...
 */
    ...
    public FireFacilityWaterPumpAdapterDBInfo() {
        count = 1;
        intakeSize = 0d;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("水泵接合器", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterPumpAdapterDBInfo.class));
        pdListDetail.add(new PropertyDes("名称*", "setName", String.class, name, PropertyDes.TYPE_EDIT, true));
        pdListDetail.add(new PropertyDes("型号", "setModelNumber", String.class, modelNumber, PropertyDes.TYPE_EDIT));
        pdListDetail.add(new PropertyDes("安装形式", "setInstallation", String.class, installation, LvApplication.getInstance().getCompDicMap().get("ZDDW_SP_AZXS")));
        pdListDetail.add(new PropertyDes("进水口尺寸(mm)", "setIntakeSize", Double.class, intakeSize, PropertyDes.TYPE_EDIT));
