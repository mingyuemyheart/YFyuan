...
public class StorageMediaJsonInfo implements IPropertyPartInfo {
    private String name;
    ...
    public String getAttr2() {
        return StringUtil.get(height);
    }

    @Override
    public void setAttr2(String attr2) {
        height = Utils.convertToDouble(attr2);
    }
    ...
    public String getType() {
        return AppDefs.KeyUnitJsonType.JSON_STORAGE_MEDIA.toString();
    }
}
