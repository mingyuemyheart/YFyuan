 ...
 */
@Table(name = "fire_facility_auto_alarm_system")
public class FireFacilityAutoAlarmSystemDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
 ...
 */
    ...
    public FireFacilityAutoAlarmSystemDBInfo() {
        count = 1;
        usable = true;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("自动报警系统", uuid, PropertyDes.TYPE_NONE, FireFacilityAutoAlarmSystemDBInfo.class));
