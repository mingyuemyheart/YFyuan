 ...
 */
@Table(name = "key_part_device")
public class KeyPartDeviceDBInfo implements IKeyPartInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 5465641220422258861L;
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("重点部位-装置类", uuid, PropertyDes.TYPE_NONE, KeyPartDeviceDBInfo.class));
