...
/**
 * partition_structure_group
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "partition_structure_group")
public class PartitionStructureGroupDBInfo implements IPartitionInfo {
    /** 版本号 */
    @Transient
 ...
 */
    ...
    public PartitionStructureGroupDBInfo() {
        timeStationArrive = 0;
        floorArea = 0d;
        structureArea = 0d;
        heightOverground = 0d;
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("建筑群(建筑类)", uuid, PropertyDes.TYPE_NONE, PartitionStructureGroupDBInfo.class));
