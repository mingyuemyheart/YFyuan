 ...
 */
@Table(name = "partition_structure")
public class PartitionStructureDBInfo implements IPartitionInfo {
    /** 版本号 */
    @Transient
 ...
 */
    ...
    public PartitionStructureDBInfo() {
        timeStationArrive = 0;
        floorArea = 0d;
        structureArea = 0d;
        heightOverground = 0d;
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("建筑", uuid, PropertyDes.TYPE_NONE, PartitionStructureDBInfo.class));
