...
/**
 * 其他灭火系统-气体灭火系统(fire_facility_extinguishing_gas)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_extinguishing_gas")
public class FireFacilityExtinguishingGasDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 7125282408322400384L;
 ...
 */
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("气体灭火系统", uuid, PropertyDes.TYPE_NONE, FireFacilityExtinguishingGasDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes("气体种类", "setGasType", String.class, gasType, PropertyDes.TYPE_EDIT));
