...
/**
 * 其他消防设施-其他消防设施(fire_facility_device)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_device")
public class FireFacilityDeviceDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -4934512720946149378L;
 ...
 */
    ...
    public FireFacilityDeviceDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("其他消防设施", uuid, PropertyDes.TYPE_NONE, FireFacilityDeviceDBInfo.class));
