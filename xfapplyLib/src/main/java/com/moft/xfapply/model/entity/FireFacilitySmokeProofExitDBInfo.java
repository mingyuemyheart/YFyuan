...
/**
 * 防排烟设施-排烟口/出烟口(fire_facility_smoke_proof_exit)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_smoke_proof_exit")
public class FireFacilitySmokeProofExitDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -2384797444595142392L;
 ...
 */
    ...
    public FireFacilitySmokeProofExitDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("排烟口/出烟口(层)", uuid, PropertyDes.TYPE_NONE, FireFacilitySmokeProofExitDBInfo.class));
