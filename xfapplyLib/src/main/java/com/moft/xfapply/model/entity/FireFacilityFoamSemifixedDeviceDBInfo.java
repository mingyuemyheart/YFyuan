...
/**
 * 泡沫系统-半固定设施(fire_facility_foam_semifixed_device)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_foam_semifixed_device")
public class FireFacilityFoamSemifixedDeviceDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -7723765508544730040L;
 ...
 */
    ...
    public FireFacilityFoamSemifixedDeviceDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("半固定设施(泡沫系统)", uuid, PropertyDes.TYPE_NONE, FireFacilityFoamSemifixedDeviceDBInfo.class));
