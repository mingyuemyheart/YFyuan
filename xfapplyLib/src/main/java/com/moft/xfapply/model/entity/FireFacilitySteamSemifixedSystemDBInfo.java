...
/**
 * 蒸汽灭火系统-半固定式(fire_facility_steam_semifixed_system)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_steam_semifixed_system")
public class FireFacilitySteamSemifixedSystemDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 4310332318660736186L;
 ...
 */
    ...
    /** 额定压力（MPa）
 */
    @Property(column = "specified_pressure")
    ...
    public FireFacilitySteamSemifixedSystemDBInfo() {
        count = 1;
        specifiedPressure = 0d;
    }

    public List<PropertyDes> getPdListDetail() {
        pdListDetail.clear();

        pdListDetail.add(new PropertyDes("半固定蒸汽系统", uuid, PropertyDes.TYPE_NONE, FireFacilitySteamSemifixedSystemDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes("额定压力(MPa)", "setSpecifiedPressure", Double.class, specifiedPressure, PropertyDes.TYPE_EDIT));
