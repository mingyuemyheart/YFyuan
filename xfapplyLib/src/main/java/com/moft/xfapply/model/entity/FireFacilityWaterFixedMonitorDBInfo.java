...
/**
 * 消防水系统-固定水炮(fire_facility_water_fixed_monitor)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_fixed_monitor")
public class FireFacilityWaterFixedMonitorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 3631188010873241954L;
 ...
 */
    ...
    public FireFacilityWaterFixedMonitorDBInfo() {
        count = 1;
        usable = true;
        flow = 0d;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("固定水炮", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterFixedMonitorDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes("位置", "setLocation", String.class, address, PropertyDes.TYPE_EDIT));
