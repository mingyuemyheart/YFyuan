...
/**
 * 消防水系统-泵房(fire_facility_water_pump_room)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_pump_room")
public class FireFacilityWaterPumpRoomDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -1311112111498952677L;
 ...
 */
    ...
    /** 消火栓泵数量
 */
    @Property(column = "hydrant_pump_count")
    private Integer hydrantPumpCount;
    /** 消火栓泵最大流量（L/s）
 */
    @Property(column = "hydrant_pump_maximum_flow")
    private Double hydrantPumpMaximumFlow;
    /** 喷淋泵数量 */
    @Property(column = "spray_pump_count")
    private Integer sprayPumpCount;
    /** 喷淋泵最大流量（L/s）
 */
    @Property(column = "spray_pump_maximum_flow")
    ...
    public FireFacilityWaterPumpRoomDBInfo() {
        count = 1;
        hydrantPumpCount = 0;
        hydrantPumpMaximumFlow = 0d;
        sprayPumpCount = 0;
        sprayPumpMaximumFlow = 0d;
    }

    public List<PropertyDes> getPdListDetail() {
        pdListDetail.clear();

        pdListDetail.add(new PropertyDes("消防泵房", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterPumpRoomDBInfo.class));
        pdListDetail.add(new PropertyDes("名称*", "setName", String.class, name, PropertyDes.TYPE_EDIT, true));
        pdListDetail.add(new PropertyDes("消火栓泵数量", "setHydrantPumpCount", Integer.class, hydrantPumpCount, PropertyDes.TYPE_EDIT));
        pdListDetail.add(new PropertyDes("消火栓泵最大流量(L/s)", "setHydrantPumpMaximumFlow", Double.class, hydrantPumpMaximumFlow, PropertyDes.TYPE_EDIT));
        pdListDetail.add(new PropertyDes("喷淋泵数量", "setSprayPumpCount", Integer.class, sprayPumpCount, PropertyDes.TYPE_EDIT));
        pdListDetail.add(new PropertyDes("喷淋泵最大流量(L/s)", "setSprayPumpMaximumFlow", Double.class, sprayPumpMaximumFlow, PropertyDes.TYPE_EDIT));
    ...
    public Double getHydrantPumpMaximumFlow() {
        return this.hydrantPumpMaximumFlow;
    }
    ...
    public Integer getSprayPumpCount() {
        return this.sprayPumpCount;
    }

    /**
     * 设置喷淋泵数量
     * 
     * @param sprayPumpCount
     *          喷淋泵数量
     */
    ...
    public Double getSprayPumpMaximumFlow() {
        return this.sprayPumpMaximumFlow;
    }
