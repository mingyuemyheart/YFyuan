...
/**
 * 泡沫系统-泡沫发生器(fire_facility_foam_generator)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_foam_generator")
public class FireFacilityFoamGeneratorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -1542239870994212477L;
 ...
 */
    ...
    public FireFacilityFoamGeneratorDBInfo() {
        count = 1;
        flow = 0d;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("泡沫发生器", uuid, PropertyDes.TYPE_NONE, FireFacilityFoamGeneratorDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes("流量(L/s)", "setFlow", Double.class, flow, PropertyDes.TYPE_EDIT));
