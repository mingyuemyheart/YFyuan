...
/**
 * 泡沫系统-固定泡沫炮(fire_facility_foam_fixed_monitor)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_foam_fixed_monitor")
public class FireFacilityFoamFixedMonitorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -4227322718960648276L;
 ...
 */
    ...
    public FireFacilityFoamFixedMonitorDBInfo() {
        count = 1;
        usable = true;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("固定泡沫炮", uuid, PropertyDes.TYPE_NONE, FireFacilityFoamFixedMonitorDBInfo.class));
