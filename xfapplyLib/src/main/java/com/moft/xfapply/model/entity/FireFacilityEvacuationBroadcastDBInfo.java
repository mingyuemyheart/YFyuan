...
/**
 * 安全疏散设施-应急广播(fire_facility_evacuation_broadcast)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_evacuation_broadcast")
public class FireFacilityEvacuationBroadcastDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 799212202171952746L;
 ...
 */
    ...
    public FireFacilityEvacuationBroadcastDBInfo() {
        count = 1;
        installed = true;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("应急广播", uuid, PropertyDes.TYPE_NONE, FireFacilityEvacuationBroadcastDBInfo.class));
