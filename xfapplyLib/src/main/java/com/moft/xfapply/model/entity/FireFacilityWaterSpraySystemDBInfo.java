...
/**
 * 消防水系统-喷淋系统(fire_facility_water_spray_system)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_spray_system")
public class FireFacilityWaterSpraySystemDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -3999811815456337672L;
 ...
 */
    ...
    public FireFacilityWaterSpraySystemDBInfo() {
        count = 1;
        installed = true;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("喷淋系统(建筑)", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterSpraySystemDBInfo.class));
