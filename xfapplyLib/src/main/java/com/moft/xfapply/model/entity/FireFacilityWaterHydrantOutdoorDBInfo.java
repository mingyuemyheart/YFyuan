...
/**
 * 消防水系统-室外消火栓(fire_facility_water_hydrant_outdoor)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_hydrant_outdoor")
public class FireFacilityWaterHydrantOutdoorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 2860761797914851025L;
 ...
 */
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("室外消火栓", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterHydrantOutdoorDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes("压力型号", "setPressureModel", String.class, pressureModel, PropertyDes.TYPE_EDIT));
