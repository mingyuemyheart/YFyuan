...
/**
 * 泡沫系统-消火栓(fire_facility_foam_hydrant)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_foam_hydrant")
public class FireFacilityFoamHydrantDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -4885862394192549434L;
 ...
 */
    ...
    public FireFacilityFoamHydrantDBInfo() {
        count = 1;
        usable = true;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("泡沫消火栓", uuid, PropertyDes.TYPE_NONE, FireFacilityFoamHydrantDBInfo.class));
