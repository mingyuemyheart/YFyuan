...
/**
 * 重点部位-建筑类(key_part_structure)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "key_part_structure")
public class KeyPartStructureDBInfo implements IKeyPartInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 450502191686202025L;
    ...
    /** 危险介质
     */
    @Property(column = "hazard_media_json")
    private String hazardMediaJson; //危险介质
    /** 危险性分析
     */
    @Property(column = "risk_analysis")
    private String riskAnalysis; //危险性分析
    /** 注意事项
     */
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("重点部位-建筑类", uuid, PropertyDes.TYPE_NONE, KeyPartStructureDBInfo.class));
        ...
        pdListDetail.add(new PropertyDes(Constant.KEY_UNIT_JSON_TITLE_WXJZ, "setHazardMediaJson", String.class, hazardMediaJson, PropertyDes.TYPE_PART_LIST));
