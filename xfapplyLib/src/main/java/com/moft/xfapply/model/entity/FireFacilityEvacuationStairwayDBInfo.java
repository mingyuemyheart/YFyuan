...
/**
 * 安全疏散设施-疏散楼梯(fire_facility_evacuation_stairway)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_evacuation_stairway")
public class FireFacilityEvacuationStairwayDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 4076251584342260429L;
    ...
    public FireFacilityEvacuationStairwayDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("疏散楼梯(层)", uuid, PropertyDes.TYPE_NONE, FireFacilityEvacuationStairwayDBInfo.class));
