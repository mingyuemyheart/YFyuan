...
/**
 * 蒸汽灭火系统-固定式(fire_facility_steam_fixed_system)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_steam_fixed_system")
public class FireFacilitySteamFixedSystemDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 2927656437449512358L;
 ...
 */
    ...
    public FireFacilitySteamFixedSystemDBInfo() {
        count = 1;
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("固定式蒸汽系统", uuid, PropertyDes.TYPE_NONE, FireFacilitySteamFixedSystemDBInfo.class));
