...
/**
 * 安全疏散设施-避难层(fire_facility_evacuation_waiting_floor)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_evacuation_waiting_floor")
public class FireFacilityEvacuationWaitingFloorDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -6401888164243728449L;
 ...
 */
    ...
    public FireFacilityEvacuationWaitingFloorDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("避难层(间)", uuid, PropertyDes.TYPE_NONE, FireFacilityEvacuationWaitingFloorDBInfo.class));
