...
/**
 * 消防水系统-冷却水系统(fire_facility_water_cooling_system)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_cooling_system")
public class FireFacilityWaterCoolingSystemDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 5441931863688856773L;
 ...
 */
    ...
    /** 供水强度（L/min.m2）
 */
    @Property(column = "supply_strength")
 ...
 */
    ...
    public FireFacilityWaterCoolingSystemDBInfo() {
        count = 1;
        installed = true;
        supplyStrength = 0d;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("冷却水系统(装置/储罐)", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterCoolingSystemDBInfo.class));
        pdListDetail.add(new PropertyDes("名称*", "setName", String.class, name, PropertyDes.TYPE_EDIT, true));
        pdListDetail.add(new PropertyDes("供水强度(L/min.m2)", "setSupplyStrength", Double.class, supplyStrength, PropertyDes.TYPE_EDIT));
        pdListDetail.add(new PropertyDes("有/无", "setInstalled", Boolean.class, installed, LvApplication.getInstance().getHasOrNohasDicList()));
