...
/**
 * 消防水系统-半固定设施(fire_facility_water_semifixed_device)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_semifixed_device")
public class FireFacilityWaterSemifixedDeviceDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = 7234558375261188432L;
 ...
 */
    ...
    public FireFacilityWaterSemifixedDeviceDBInfo() {
        count = 1;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("半固定设施(消防水系统)", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterSemifixedDeviceDBInfo.class));
