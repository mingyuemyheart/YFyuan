...
/**
 * 消防水系统-水箱(fire_facility_water_tank)
 * 
 * @author wangx
 * @version 1.0.0 2018-05-22
 */
@Table(name = "fire_facility_water_tank")
public class FireFacilityWaterTankDBInfo implements IFireFacilityInfo {
    /** 版本号 */
    @Transient
    private static final long serialVersionUID = -2420679453682217517L;
 ...
 */
    ...
    public FireFacilityWaterTankDBInfo() {
        count = 1;
        capacity = 0d;
        supplySpeed = 0d;
    }
    ...
    public List<PropertyDes> getPdListDetail() {
        ...
        pdListDetail.add(new PropertyDes("消防水箱", uuid, PropertyDes.TYPE_NONE, FireFacilityWaterTankDBInfo.class));
