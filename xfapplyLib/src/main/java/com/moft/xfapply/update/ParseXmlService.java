	...
	public HashMap<String, String> parseXml(InputStream inStream)
		...
		for (int j = 0; j < childNodes.getLength(); j++) {
			...
			if (childNode.getNodeType() == Node.ELEMENT_NODE) {
				...
				// 是否强制更新
				else if (("force_update".equals(childElement.getNodeName()))) {
					String value = childElement.getFirstChild() != null ?  childElement.getFirstChild().getNodeValue() : "";
					hashMap.put("force_update", value);
				}
				// 获取versionName
				else if (("versionName".equals(childElement.getNodeName()))) {
					String value = childElement.getFirstChild() != null ?  childElement.getFirstChild().getNodeValue() : "";
					hashMap.put("versionName", value);
				}
				// 获取提示信息
				else if (("prompt".equals(childElement.getNodeName()))) {
					String value = childElement.getFirstChild() != null ?  childElement.getFirstChild().getNodeValue() : "";
					hashMap.put("prompt", value);
				}
			}
		}
		return hashMap;
